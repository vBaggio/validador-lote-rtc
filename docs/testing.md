...
| componentes Swing de fontes | atualização na EDT, rodapé compacto com proveniência no tooltip, cards com colunas adaptáveis e origem amigável, diálogo sem minimizar com botão Fechar, abertura modal adiada após o dreno, spinner terminal, rolagem/adaptação e fechamento bloqueado durante `APPLYING` |
