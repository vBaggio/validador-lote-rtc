...
| componentes Swing de fontes | atualização na EDT, rodapé compacto com proveniência no tooltip, cards com colunas adaptáveis, diálogo sem minimizar e sem botão redundante de fechar, abertura modal adiada após o dreno, spinner terminal, rolagem/adaptação e fechamento bloqueado durante `APPLYING` |
